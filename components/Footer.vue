...
<template>
  <div
    class="before:block before:absolute before:bg-[#D87D4A] before:h-1 before:top-0 before:w-[101px] before:left-1/2 before:-translate-x-1/2 bg-black text-center pt-[52px] pb-[38px] relative"
  >
    <div class="container">
      <svg
        class="mx-auto mb-[48px]"
        width="143"
        height="25"
      ...
      <ul class="flex flex-col items-center justify-center gap-y-4 mb-[48px]">
        <li v-for="footerLink in footerLinks">
          <a
            class="text-white uppercase text-[13px] leading-[25px] tracking-[2px] transition-colors hover:text-[#D87D4A]"
            :href="footerLink.url"
            >{{ footerLink.text }}</a
          >
        </li>
      ...
      <div class="text-white text-[15px] leading-[25px] opacity-50 mb-[48px]">
