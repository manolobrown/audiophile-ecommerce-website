...
<template>
  ...
  >
    ...
    <div
      class="text-center max-w-[573px] mx-auto xl:max-w-[445px] xl:text-left xl:m-0"
    >
      <h2
        class="text-black uppercase text-[28px] tracking-[1px] mb-[32px] md:text-[40px] md:tracking-[1.43px] md:leading-[44px]"
      >
        <strong
      ...
      <p
        class="text-black text-[15px] leading-[25px] opacity-50 mb-[24px] md:mx-2"
      >
  ...
  >
    <div
      class="container before:block before:absolute before:bg-[#D87D4A] before:h-1 before:top-[-52px] before:w-[101px] before:left-1/2 before:-translate-x-1/2 relative md:before:left-[2.5rem] md:before:translate-x-0 xl:before:left-0"
    >
      ...
      <p
        class="text-white text-[15px] leading-[25px] opacity-50 mb-[48px] md:mb-20 xl:max-w-[540px]"
      >
      ...
      <div class="md:flex md:justify-between md:items-center">
        <div
          class="text-white text-[15px] leading-[25px] opacity-50 mb-[48px] md:mb-0"
        >
          Copyright 2021. All Rights Reserved
        </div>
        <ul
          class="flex items-center justify-center gap-x-4 xl:absolute xl:right-0 xl:top-1/2 xl:-translate-y-1/2"
        >
          <li>
            <a href=""
