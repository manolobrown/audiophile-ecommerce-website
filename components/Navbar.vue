...
<template>
  <div class="navbar-wrapper bg-[#191919] z-10 relative">
    <div
      class="navbar container flex flex-row items-center justify-between pt-[32px] pb-[32px] after:block after:h-[1px] after:absolute after:bottom-0 after:left-0 after:right-0 after:bg-white after:opacity-10 md:after:left-10 md:after:right-10"
    >
      <NavbarMobileButton @click="toggleMobileMenu()" class="lg:hidden" />
      <div class="navbar__logo md:mr-auto md:ml-11">
